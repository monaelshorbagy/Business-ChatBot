...
from langchain.document_loaders import DirectoryLoader,AmazonTextractPDFLoader,GitLoader,TextLoader
def dir_loader(path):
...
# embeddings = GoogleGenerativeAIEmbeddings(model="models/embedding-001",google_api_key="AIzaSyCrT1P1NUSzgg4y_3d_JuleWUtMcSbB-I4")
...
print(f"Documents length before: {len(ids_docs)}")

print(f"Documents length after: {len(keys_documents)}")
